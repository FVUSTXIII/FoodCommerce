...
public class ProductController {
	...
	public ResponseEntity<ProductResponseDTO> getAllProductsInStore(@PathVariable("storeId") Integer storeId){
		ProductResponseDTO productResponseDto =  productService.getAllProductsInStore(storeId);
